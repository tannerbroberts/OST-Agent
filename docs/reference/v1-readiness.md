...
> *Today:* **met** — 1847 tests across 158 files, verified 2026-08-04 (`npx vitest run`,
...
> killed the candidate and below the 70 that would let it stand on the whole record;
