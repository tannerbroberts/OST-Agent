...
> *Today:* **met** — 3,838 tests across 305 files, verified 2026-08-23 (`npx vitest run`
> reports 3,830 of them, all passing; the other 8 are the contended calibration file
> described below.
