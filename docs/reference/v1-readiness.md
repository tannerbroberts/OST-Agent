...
> *Today:* **met** — 3,851 tests across 306 files, verified 2026-08-23 (`npx vitest run`
> reports 3,843 of them, all passing; the other 8 are the contended calibration file
> described below.
